package com.opethic.memberregistrationapp.Adapters;
...
import com.opethic.memberregistrationapp.Utils.Globals;
    ...
    public class MemberListAdapterHolder extends RecyclerView.ViewHolder {
        ...
        public void bindOrder(int position) {
            ...
            if (Globals.memberListModels.size() > 0) {
                ...
                Log.e("memberName",memberNameTextView.getText().toString());
